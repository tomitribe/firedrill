...
public class ObjectFactory {
    ...
    private final static QName APPLICATION_QNAME = new QName("http://tomitribe.com/xml/ns/bytes", "bytes");
    ...
    public JAXBElement<Bytes> createBytes(final Bytes value) {
        return new JAXBElement<Bytes>(APPLICATION_QNAME, Bytes.class, null, value);
    }
